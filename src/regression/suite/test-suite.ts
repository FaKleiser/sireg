...
/**
 * Represents a  complete test suite created from a {@link TestSuiteConfig} that is ready to be executed.
 */
export class TestSuite {
    ...
    constructor(private _config: TestSuiteConfig) {
        if (!this._config) {
